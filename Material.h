...
class Material  {
public:
    __device__ virtual bool scatter(const Ray& r_in, const Intersection_Information& rec, Vec3D& attenuation, Ray& scattered, curandState *local_rand_state) const = 0;
...
public:
    ...
    __device__ virtual bool scatter(const Ray& r_in, const Intersection_Information& rec, Vec3D& attenuation, Ray& scattered, curandState *local_rand_state) const  {
...
public:
    ...
    __device__ bool scatter(const Ray &r_in, const Intersection_Information &rec, Vec3D &attenuation, Ray &scattered,
...
private:
    ...
    // -----------------------------------------------------------------------
    Vec3D light_color;                                  // color of the light
